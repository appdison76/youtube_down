...
다른 파일명을 사용하고 싶다면 `index.html` 파일에서 이미지 경로를 수정해주세요.

예:
- `screenshots/my-download.jpg`
- `screenshots/my-files.jpg`
- `screenshots/my-favorites.jpg`
